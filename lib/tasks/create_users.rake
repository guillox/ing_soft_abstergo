users = {
  ...
  :no_admin_oportunity => { :name => "oportunity", :last_name => "oportunity", :username => "oportunity", :email => "oportunity@bestnid.com.ar", :email_confirmation => "oportunity@bestnid.com.ar", :password => "gaspar", :password_confirmation => "gaspar", :admin => false, :active => true },
